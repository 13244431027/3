...
(function (Scratch) {
  "use strict";
  if (!Scratch.extensions.unsandboxed) throw new Error("更好的输入必须在非沙盒环境中运行");
...
"data:image/svg+xml;base64,";
  ...
  class BetterInputSP {
    constructor() {
      ...
      this.optionList = ["选项 1", "选项 2", "选项 3"];
      this.sliderInfo = [0, 100, 50];
      this.Timeout = 0;

      this.inputType = "启用";
      this.fontSize = "14px"; this.fontFamily = "无衬线字体"; this.textAlign = "left";
        ...
        blocks: [
          {
            ...
            arguments: {
              question: { type: Scratch.ArgumentType.STRING, defaultValue: "你叫什么名字？" }
            },
          },
          {
          ...
          },
          {
            opcode: "setDefaultV",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置默认值为 [defaultV]",
            arguments: {
              defaultV: { type: Scratch.ArgumentType.STRING, defaultValue: "我的名字是..." }
            },
          },
          {
          ...
          { blockType: Scratch.BlockType.LABEL, text: "格式化" },
          {
            opcode: "setFontSize",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置字体大小为 [SIZE]",
          ...
          },
          {
            opcode: "setDropdown",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置下拉菜单选项为数组: [DROPDOWN]",
            blockIconURI: formatIcon,
            arguments: {
              DROPDOWN: { type: Scratch.ArgumentType.STRING, defaultValue: "[\"选项 1\", \"选项 2\", \"选项 3\"]" }
            },
          },
          {
            opcode: "setSlider",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置滑块 最小值: [MIN] 最大值: [MAX] 默认值: [DEFAULT]",
            blockIconURI: formatIcon,
            arguments: {
          ...
          },
          {
            ...
            blockIconURI: formatIcon, text: "x 位置"
          },
          {
            opcode: "getYpos", blockType: Scratch.BlockType.REPORTER,
            blockIconURI: formatIcon, text: "y 位置"
          },
          {
            opcode: "setDirection",
            blockType: Scratch.BlockType.COMMAND,
          ...
          },
          {
            ...
            text: "方向", blockIconURI: formatIcon
          },
          { blockType: Scratch.BlockType.LABEL, text: "视觉设置" },
          {
            opcode: "setColorSettings",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [COLOR_TYPE] 颜色为 [COLOR]",
          ...
          "---",
          {
            opcode: "setImage",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [ELEMENT] 图片为 [IMAGE]",
            blockIconURI: colorIcon,
            arguments: {
              ELEMENT: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" },
              IMAGE: { type: Scratch.ArgumentType.STRING, defaultValue: "输入图片URL" }
            },
          },
          {
            opcode: "scaleImage",
            blockType: Scratch.BlockType.COMMAND,
            text: "缩放 [ELEMENT] 图片为 [SCALE]%",
            blockIconURI: colorIcon,
            arguments: {
              ELEMENT: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [ELEMENT] 阴影为 x [x] y [y] z [z] 颜色 [COLOR]",
            blockIconURI: colorIcon,
            arguments: {
          ...
          },
          {
            opcode: "setOutline",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [ELEMENT] 轮廓为 [COLOR] 粗细 [THICK]",
            blockIconURI: colorIcon,
            arguments: {
              ELEMENT: { type: Scratch.ArgumentType.STRING, menu: "textsMenu" },
              COLOR: { type: Scratch.ArgumentType.COLOR },
          ...
          "---",
          {
            opcode: "setBorder",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [ELEMENT] 边框为 [TYPE] 颜色 [COLOR] 宽度 [WIDTH]",
            blockIconURI: colorIcon,
            arguments: {
              ELEMENT: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" },
          ...
          "---",
          {
            opcode: "setPadding",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置 [ELEMENT] 内边距为 上: [N1] 下: [N3] 左: [N4] 右: [N2]",
            blockIconURI: colorIcon,
            arguments: {
              ELEMENT: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" },
          ...
          { blockType: Scratch.BlockType.LABEL, text: "操作" },
          {
            opcode: "setUI",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置UI顺序为 [ARRAY]",
          ...
          // 已弃用
          {
            ...
            text: "设置 [COLOR_TYPE] 颜色为渐变 [COLOR1] 和 [COLOR2] 方向 [DIR]",
            ...
            text: "设置 [COLOR_TYPE] 颜色为径向渐变 [COLOR1] 和 [COLOR2] 位置 x [X] y [Y]",
            hideFromPalette: true,
            arguments: {
            ...
            hideFromPalette: true, text: "设置 [ENABLE_MENU] 为 [ACTION]",
            arguments: {
            ...
            opcode: "getBoxCount", blockType: Scratch.BlockType.REPORTER, hideFromPalette: true, text: "框数量"
          }, {
            opcode: "getMaxCount", blockType: Scratch.BlockType.REPORTER, hideFromPalette: true, text: "框限制"
          }
        ],
        menus: {
          enableMenu: { acceptReporters: true, items: ["按钮 2", "按钮 3", "按钮 4", "文本框阴影"] },
          // ^ 旧菜单 ^ (需要V2支持)
          fontMenu: { acceptReporters: true, items: "allFonts" },
          buttonMenu: {
            acceptReporters: true,
            items: this.allButtons(["下拉菜单"], false),
          },
          elementMenu: {
            acceptReporters: true,
            items: this.allButtons(["文本框", "输入框", "下拉菜单按钮"], false),
          },
          colorSettingsMenu: {
            acceptReporters: true,
          ...
          textsMenu: {
            acceptReporters: true,
            items: this.allButtons(["问题文本", "输入文本", "下拉菜单文本"], true, true),
          },
          appendMenu: ["窗口", "画布"],
          buttonType: { acceptReporters: true, items: ["添加", "移除"] },
          buttonActionMenu: { acceptReporters: true, items: ["启用", "禁用"] },
          alignmentMenu: { acceptReporters: true, items: ["左对齐", "右对齐", "居中"] },
          shadowStuff: { acceptReporters: true, items: ["大小", "X", "Y"] },
          boxInfo: {
            acceptReporters: true,
            items: ["数量", "限制", "按钮数量", "按钮名称"],
          },
          inputActionMenu: {
            acceptReporters: true,
            items: [
    ...
    allButtons(array, enableTxt, justTxt) {
      ...
      if (justTxt) customBtn = customBtn.map(btn => btn + " 文本");
      else if (enableTxt) customBtn.forEach((btn) => { customBtn.push(btn + " 文本") });
    ...
    updateOverlayPos(overlay) {
      ...
      if (this.textBoxX !== null && this.textBoxY !== null) {
        if (this.appendTarget[0] === "窗口") {
          overlay.style.left = `${50 + this.textBoxX}%`;
          overlay.style.top = `${50 + this.textBoxY}%`;
        }
        overlay.style.transform = `
          translate${this.appendTarget[0] === "窗口" ? "(-50%, -50%)" : `(${-50 + this.textBoxX}%, ${-50 + this.textBoxY}%)` }
    ...
    updateButtonImages(overlay) {
      ...
      const inputField = overlay.querySelector(this.inputType.includes("单选") ? "select" : this.inputType === "文本区域" ? "textarea" : "input");
      if (inputField) {
        const inpWidth = parseInt(this.mainUIinfo.dimensions[0]);
        inputField.style.width = this.inputType === "颜色" || this.inputType.includes("单选") ? "100%" :
          this.inputType === "水平滑块" ? "95%" : isNaN(inpWidth) || this.inputType.includes("下拉菜单") ? "auto" : `${inpWidth - 10}px`;
    ...
    setColorSettings(args) {
      ...
      const colorTypeMap = {
        "问题文本": () => this.questionColor = colorValue,
        "输入文本": () => this.inputColor = colorValue,
        "文本框": () => { this.textBoxColor[0] = colorValue; this.overlayImage[0] = " "; },
        "文本框阴影": () => { this.shadowS[3] = colorValue },
        "输入框": () => { this.inputFieldColor = colorValue; this.overlayImage[1] = " "; },
        "下拉菜单按钮": () => { this.dropdwnBtnColor[0] = colorValue; this.overlayImage[2] = " "; },
        "下拉菜单文本": () => this.dropdwnBtnColor[1] = colorValue,
      };
      const buttonInfo = this.buttonJSON[colorType] || this.buttonJSON[colorType.replace(" 文本", "")];
      if (buttonInfo) {
        if (colorType.includes(" 文本")) buttonInfo.textColor = colorValue;
        else {
    ...
    findGradientType(menu) {
      const colorTypeMap = {
        文本框: { newColorType: "textBoxColor", ind: 0 },
        "下拉菜单按钮": { newColorType: "dropdwnBtnColor", ind: 2 }
      };
    ...
    setBorder(args) {
      ...
      this.callStyling(
        ...
        { 文本框: "overlayBord", "输入框": "inputBord", "下拉菜单按钮": "dropBtnBord" }
      );
    }
    ...
    setBorderRadius(args) {
      this.callStyling(
        ...
        { 文本框: "overlayRad", "输入框": "inputRad", "下拉菜单按钮": "dropBtnRad" }
      );
    }
    ...
    setPadding(args) {
      ...
      this.callStyling(
        ...
        { 文本框: "overlayPad", "输入框": "inputPad", "下拉菜单按钮": "dropBtnPad" }
      );
    }
    ...
    setDropShadow(args) {
      ...
      this.callStyling(
        ...
        { "问题": "overlayTxtShad", "输入": "inputTxtShad", "下拉菜单": "dropBtnTxtShad" }
      );
    }
    ...
    setOutline(args) {
      ...
      this.callStyling(
        ...
        { "问题": "overlayOutline", "输入": "inputOutline", "下拉菜单": "dropBtnOutline" }
      );
    }

    setShadow(args) {
      const shadowMap = { 大小: 2, X: 0, Y: 1 };
    ...
    setImage(args) {
      const elementMap = { 文本框: 0, "输入框": 1, "下拉菜单按钮": 2 };
    ...
    setInputType(args) {
      if (args.ACTION === "文本" || args.ACTION ===  "无") this.inputType = args.ACTION === "文本" ? "启用" : "禁用";
      else this.inputType = args.ACTION;
    }

    enableShadow(args) { this.shadowEnabled = args.ACTION === "启用" }

    setButtonText(args) {
      const buttonMenu = args.BUTTON_MENU;
      const text = args.TEXT;
      if (buttonMenu === "下拉菜单") this.DropdownText = text;
    ...
    removeAskBoxes() {
      ...
      this.activeOverlays.forEach((overlay) => {
        if (overlay) {
          if (this.appendTarget[0] === "窗口" && overlay.parentNode) overlay.parentNode.removeChild(overlay);
        ...
        if (this.askBoxPromises) {
          ...
          if (index !== -1) this.askBoxPromises[index].resolve("已移除");
        }
      });
      this.askBoxPromises = [];
    ...
    askAndWait(args) {
      if (this.askBoxInfo[0] < this.askBoxInfo[1]) {
        ...
        return new Promise((resolve) => {
          ...
          overlay.style.left = this.appendTarget[0] === "窗口" ? `${50 + this.textBoxX}%` : "0%";
          overlay.style.top = this.appendTarget[0] === "窗口" ? `${50 + this.textBoxY}%` : "0%";
          ...
          focusBG.style.left = this.appendTarget[0] === "窗口" ? "0%" : "-50%";
          focusBG.style.top = this.appendTarget[0] === "窗口" ? "0%" : "-50%";
          ...
          if (this.forceInput !== "禁用") {
            const overlayInput = this.forceInput === "回车键" ? "Enter" : this.forceInput === "Shift + 回车键" ? "ShiftEnter" : this.forceInput;
          ...
          const inputField = document.createElement(this.inputType === "文本区域" ? "textarea" : "input");
          inputField.style.display = this.inputType ? "block" : "none";
          inputField.style.fontSize = this.fontSize;
          inputField.style.margin = "0 auto";
          if (this.inputType !== "文本区域") inputField.type = this.inputType.toLowerCase();
          ...
          for (const buttonName in this.buttonJSON) {
            ...
            if (btnInfo.name.includes("<newline>")) btnContain.appendChild(document.createElement("br"));
              ...
              btn.addEventListener("click", () => {
                ...
                setInpValue(this.inputType === "禁用" ? btnInfo.name : this.userInput);
                this.closeOverlay(overlay, hasDecreased);
                hasDecreased = true;
                resolve();
              });
          ...
          if (this.inputType.includes("下拉菜单")) {
            const dropdown = document.createElement("div");
            dropdown.className = "dropdown";
            if (this.inputType === "单选下拉菜单") {
              ...
              const isMulti = this.inputType.includes("多选");
              let defaultOpts = [];
              if (isMulti) {
                try {
              ...
              this.optionList.forEach((label, index) => {
                ...
                optRadio.type = this.inputType === "下拉菜单" ? "radio" : "checkbox";
          ...
          } else if (this.inputType.includes("滑块")) {
          ...
          for (const item of this.uiOrder) {
            switch (item) {
              ...
              case "input":
                if (this.inputType !== "禁用") {
                  const createBr = () => { return document.createElement("br") };
                  if (this.inputType === "单选下拉菜单") overlay.append(dropdwnBtn, createBr());
                  else if (this.inputType.includes("下拉菜单")) overlay.append(dropdwnBtn, dropdwnCont, createBr());
                  else if (this.inputType.includes("滑块")) overlay.append(sliderContain, valTxt, createBr());
                  else {
                    setInpValue(this.defaultValue);
          ...
          inputField.focus();
          if (this.appendTarget[0] === "窗口") overlay.style.zIndex = "9999";
    ...
    closeOverlay(overlay, doneBefore) {
      ...
      if (!doneBefore) {
        ...
        setTimeout(() => {
          ...
          if (this.appendTarget[0] === "窗口") document.body.removeChild(overlay);
          else vm.renderer.removeOverlay(overlay);
          if (usedBG) {
            if (usedBG.id === "窗口") document.body.removeChild(usedBG);
    ...
    setFocus(args) { this.appendTarget[1] = args.TYPE === "启用" }
    ...
    // 已弃用
    setEnable() { throw new Error("此块已在更好的输入 V3 中移除。请使用新的强大块") }
    getBoxCount() { return this.askBoxInfo[0] }
    getMaxCount() { return this.askBoxInfo[1] }
    setGradient(t){if("输入框"===t.COLOR_TYPE)throw Error("自更好的输入 V4 起，此选项不再有效");let i=this.findGradientType(t.COLOR_TYPE),e=`linear-gradient(${t.DIR-90}deg, ${t.COLOR2}, ${t.COLOR1})`;"button"!==i[0]?this[i][0]=e:this.buttonJSON[i[1]].color=e,this.activeOverlays.forEach(t=>{this.updateOverlay(t)})}
