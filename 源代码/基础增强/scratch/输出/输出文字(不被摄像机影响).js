...
(function (Scratch) {
  "use strict";
  if (!Scratch.extensions.unsandboxed) throw new Error("显示文本扩展必须在非沙盒模式下运行！");
...
"data:image/svg+xml;base64,";
  ...
  class SPdisText {
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          { blockType: Scratch.BlockType.LABEL, text: "格式设置" },
          {
            opcode: "setTextFont",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的字体为 [FONT]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          },
          {
            opcode: "setMargins",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的边距为宽度 [WIDTH] 高度 [HEIGHT]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的 [ATT] 间距为 [SPACING] px",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的文本阴影为 x [x] y [y] 模糊 [z] 颜色 [COLOR]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的文本描边为 [COLOR] 粗细 [THICKNESS]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
              COLOR: { type: Scratch.ArgumentType.COLOR, defaultValue: "#ff0000" },
          ...
          },
          {
            opcode: "setLine",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的文本线条为 [TYPE1] [TYPE2] 颜色 [COLOR] 粗细 [THICK]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          "---",
          {
            opcode: "makeGradient",
            blockType: Scratch.BlockType.REPORTER,
            text: "创建 [TYPE] 渐变色 [COLOR1] 和 [COLOR2] 角度 [ANGLE]",
            arguments: {
          ...
          { blockType: Scratch.BlockType.LABEL, text: "↓ 会丢失部分格式 ↓" },
          {
            opcode: "setTextCurve",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的文本曲线为 [ARC]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
          ...
          { blockType: Scratch.BlockType.LABEL, text: "位置设置" },
          {
            opcode: "presetTextPosition",
            blockType: Scratch.BlockType.COMMAND,
            text: "预设ID [ID] 的位置为 x: [X] y: [Y]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
              X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 }
          ...
          { blockType: Scratch.BlockType.LABEL, text: "特效" },
          {
            opcode: "setEffect",
            blockType: Scratch.BlockType.COMMAND,
            text: "设置ID [ID] 的 [EFFECT] 为 [VALUE]",
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: "my-text" },
        ...
        menus: {
          ...
          LINE_TYPE: { acceptReporters: true, items: ["下划线", "删除线"] },
          ALIGNMENTS: { acceptReporters: true, items: ["左对齐", "右对齐", "居中"] },
          GRADIENTS: { acceptReporters: true, items: ["线性", "径向"] },
          THICK: [
            { text : "粗", value : "900" },
            { text : "中等", value : "600" },
            { text : "无", value : "1" },
          ...
          FORMATS: {
            acceptReporters: true,
            items: [
              { text: "字体", value: "fontFamily" },
              { text: "字体大小", value: "fontSize" },
              { text: "粗细", value: "fontWeight" },
              { text: "对齐", value: "textAlign" },
              { text: "边距宽度", value: "width" },
              { text: "边距高度", value: "height" },
              { text: "显示宽度", value: "box2w" },
              { text: "显示高度", value: "box2h" },
              { text: "字符间距", value: "letterSpacing" },
              { text: "行间距", value: "lineHeight" },
              { text: "溢出类型", value: "overflow" }
            ]
          },
          EFFECTS: {
            acceptReporters: true,
            items: [
              { text: "模糊", value: "blur" },
              { text: "饱和度", value: "saturate" },
              { text: "对比度", value: "contrast" },
              { text: "亮度", value: "brightness" },
              { text: "色相", value: "hue-rotate" },
              { text: "不透明度", value: "opacity" },
              { text: "复古", value: "sepia" },
              { text: "反色", value: "invert" },
              { text: "方向", value: "rotate" },
              { text: "缩放 x", value: "scaleX" },
              { text: "缩放 y", value: "scaleY" },
              { text: "倾斜 x", value: "skewX" },
              { text: "倾斜 y", value: "skewY" }
            ]
          }
        }
      };
    ...
    debug(args) {
      const toggle = args.TOGGLE === "开启" ? "solid" : "none";
    ...
    printTxt(args) {
      ...
      this.updateStyles(settings); // 添加格式（如果有）
    }
    ...
    setTextSpacing(args) {
      ...
      const elements = document.querySelectorAll(`div[id="SP_Text-Ext-${ID}"]`);
      elements.forEach((element) => {
        element.style[args.ATT === "字符" ? "letterSpacing" : "lineHeight"] = `${args.SPACING}px`;
      });
      txtSettings[ID][args.ATT === "字符" ? "letDIS" : "lineDIS"] = { ...args, ID };
    }
    ...
    textPosition(args) {
      ...
      let value;
      elements.forEach((element) => {
        if (args.ATT === "z图层") value = element.parentNode.parentNode.style.zIndex;
    ...
    toggleSelect(args) {
      const type = args.TYPE === "开启" ? "auto" : "none";
      const elements = document.querySelectorAll(`div[id="SP_Text-Ext-${this.fixID(args.ID)}"]`);
      elements.forEach((element) => {
    ...
    makeClick(args) {
      ...
      elements.forEach((element) => {
        ...
        element.removeEventListener("click", this.handleClick);
        if (args.TYPE === "开启") element.addEventListener("click", this.handleClick);
      });
    }
