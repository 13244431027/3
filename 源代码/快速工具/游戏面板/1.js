(function (Scratch) {
  ...
  if (!Scratch.extensions || !Scratch.extensions.unsandboxed) {
    throw new Error('面板GUI需要非沙盒模式以访问DOM。');
  }
  ...
  function addSlider(win, elId, labelText, min, max, defVal) {
    ...
    const lbl = labelFor(labelText || '滑块');
  ...
  function addDropdown(win, elId, labelText, opts) {
    ...
    const lbl = labelFor(labelText || '选择');
    const sel = document.createElement('select');
    for (const o of (opts || ['选项1','选项2'])) {
  ...
  function addCheckbox(win, elId, labelText, defBool) {
    ...
    const lbl = labelFor(labelText || '复选框');
  ...
  function addInput(win, elId, kind, placeholder) {
    ...
    input.placeholder = placeholder || (input.type === 'number' ? '0' : '输入...');
  ...
  class PanelGUI {
    getInfo() {
      return {
        ...
        blocks: [
          // 分区标签
          { opcode: 'label_window_mgmt', blockType: Scratch.BlockType.COMMAND, text: '--- 窗口管理 ---' },

          { opcode: 'openWindow', blockType: Scratch.BlockType.COMMAND, text: '打开窗口 [NAME] ID为: [WID]',
            arguments: { NAME: { type: Scratch.ArgumentType.STRING, defaultValue: '我的窗口' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'closeWindow', blockType: Scratch.BlockType.COMMAND, text: '关闭窗口 ID为: [WID]',
            arguments: { WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'closeAll', blockType: Scratch.BlockType.COMMAND, text: '关闭所有窗口' },

          { opcode: 'setWindowPos', blockType: Scratch.BlockType.COMMAND, text: '设置窗口 [WID] 位置为 X: [X] Y: [Y]',
          ...
          { opcode: 'setWindowSize', blockType: Scratch.BlockType.COMMAND, text: '设置窗口 [WID] 尺寸为 宽度: [W] 高度: [H]',
          ...
          { opcode: 'setWindowShowHide', blockType: Scratch.BlockType.COMMAND, text: '设置窗口 [WID] 为 [STATE]',
          ...
          { opcode: 'setWindowTitle', blockType: Scratch.BlockType.COMMAND, text: '设置窗口 [WID] 标题为: [TITLE]',
            arguments: { WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' }, TITLE: { type: Scratch.ArgumentType.STRING, defaultValue: '新标题' } } },

          { opcode: 'setWindowStyle', blockType: Scratch.BlockType.COMMAND, text: '设置窗口 [WID] 样式为 顶部: [TOP] 文本: [TEXT] 标题: [TITLECOLOR] 背景: [BG]',
            arguments: {
          ...
          { opcode: 'getWindowJSON', blockType: Scratch.BlockType.REPORTER, text: '获取 [WID] 的JSON值',
            arguments: { WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          // 分区标签
          { opcode: 'label_element_create', blockType: Scratch.BlockType.COMMAND, text: '--- 元素创建 ---' },

          { opcode: 'createButton', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 按钮 [TEXT] 按钮ID为: [GID] 设置到窗口ID: [WID]',
            arguments: { ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' }, TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: '点击我' }, GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'btn1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'createSlider', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 滑块 [LABEL] 最小值: [MIN] 最大值: [MAX] 默认值: [DEF] 滑块ID为: [GID] 设置到窗口ID: [WID]',
            arguments: { ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' }, LABEL: { type: Scratch.ArgumentType.STRING, defaultValue: '音量' }, MIN: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 }, MAX: { type: Scratch.ArgumentType.NUMBER, defaultValue: 100 }, DEF: { type: Scratch.ArgumentType.NUMBER, defaultValue: 50 }, GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'sld1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'createDropdown', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 下拉菜单 [LABEL] 选项 ([OPTS]) 下拉菜单ID为: [GID] 设置到窗口ID: [WID]',
            arguments: { ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' }, LABEL: { type: Scratch.ArgumentType.STRING, defaultValue: '模式' }, OPTS: { type: Scratch.ArgumentType.STRING, defaultValue: '选项1,选项2' }, GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'dd1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'createCheckbox', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 复选框 [LABEL] 默认: [DEF] 复选框ID为: [GID] 设置到窗口ID: [WID]',
            arguments: { ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' }, LABEL: { type: Scratch.ArgumentType.STRING, defaultValue: '启用' }, DEF: { type: Scratch.ArgumentType.STRING, menu: 'boolMenu', defaultValue: 'false' }, GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'cb1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'createText', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] [TEXTTYPE] 文本: [TEXT] 文本ID为: [GID] 设置到窗口ID: [WID]',
            arguments: {
          ...
          { opcode: 'createInput', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] [KIND] 输入框: [PLACEHOLDER] 输入框ID为: [GID] 设置到窗口ID: [WID]',
            arguments: {
              ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' },
              KIND: { type: Scratch.ArgumentType.STRING, menu: 'inputKinds', defaultValue: 'text' },
              PLACEHOLDER: { type: Scratch.ArgumentType.STRING, defaultValue: '在此输入...' },
              GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'in1' },
              WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' }
            } },

          { opcode: 'createHTML', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] HTML: [HTML] HTML ID为: [GID] 设置到窗口ID: [WID]',
          ...
          // 分区标签
          { opcode: 'label_element_controls', blockType: Scratch.BlockType.COMMAND, text: '--- 元素控制与样式 ---' },

          { opcode: 'addRaw', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] [KIND] ID: [EID] 到窗口: [WID] 自定义宽度: [W] 自定义高度: [H]',
          ...
          { opcode: 'showHideElement', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 元素: [EID] 在窗口: [WID]',
          ...
          { opcode: 'deleteElement', blockType: Scratch.BlockType.COMMAND, text: '删除元素: [EID] 在窗口: [WID]',
            arguments: { EID: { type: Scratch.ArgumentType.STRING, defaultValue: 'raw1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'addElementHTML', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 元素: [EID] HTML: [HTML] 自定义宽度: [W] 高度: [H] 到窗口: [WID]',
            arguments: { ACTION: { type: Scratch.ArgumentType.STRING, menu: 'createDelete', defaultValue: 'create' }, EID: { type: Scratch.ArgumentType.STRING, defaultValue: 'elhtml1' }, HTML: { type: Scratch.ArgumentType.STRING, defaultValue: '<b>你好</b>' }, W: { type: Scratch.ArgumentType.NUMBER, defaultValue: 160 }, H: { type: Scratch.ArgumentType.NUMBER, defaultValue: 60 }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          // 新增: 为特定窗口的文本元素设置自定义字体
          { opcode: 'setCustomFont', blockType: Scratch.BlockType.COMMAND, text: '设置自定义字体: [FONT] 到文本ID: [GID] 在窗口: [WID]',
          ...
          { opcode: 'showHideWindowButton', blockType: Scratch.BlockType.COMMAND, text: '[ACTION] 窗口 [WID] 的关闭按钮',
          ...
          { opcode: 'setWindowIcon', blockType: Scratch.BlockType.COMMAND, text: '设置 [WID] 窗口的图标为 [URL]',
            arguments: { WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' }, URL: { type: Scratch.ArgumentType.STRING, defaultValue: '' } } },

          // 分区标签
          { opcode: 'label_events_reports', blockType: Scratch.BlockType.COMMAND, text: '--- 事件与报告器 ---' },

          { opcode: 'buttonState', blockType: Scratch.BlockType.BOOLEAN, text: '<按钮 [BID] [MODE] 在窗口 [WID]?>',
          ...
          { opcode: 'windowClicked', blockType: Scratch.BlockType.BOOLEAN, text: '窗口 [WID] 被点击?',
            arguments: { WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          // 报告器
          { opcode: 'getGUIValue', blockType: Scratch.BlockType.REPORTER, text: '获取 [GID] 在窗口 [WID] 的值',
            arguments: { GID: { type: Scratch.ArgumentType.STRING, defaultValue: 'sld1' }, WID: { type: Scratch.ArgumentType.STRING, defaultValue: 'win1' } } },

          { opcode: 'getWindowPosition', blockType: Scratch.BlockType.REPORTER, text: '获取窗口 [WID] 的 [AXIS] 位置',
          ...
          { opcode: 'getWindowSize', blockType: Scratch.BlockType.REPORTER, text: '获取窗口 [WID] 的 [DIM] 尺寸',
        ...
        menus: {
          createDelete: { items: ['create', 'delete'], acceptReporters: true },
          showHide: { items: ['show', 'hide'], acceptReporters: true },
          boolMenu: { items: ['true', 'false'], acceptReporters: true },
          positionAxis: { items: ['X', 'Y'], acceptReporters: true },
          sizeDim: { items: ['Width', 'Height'], acceptReporters: true },
          rawKinds: { items: ['HTML', 'CSS'], acceptReporters: true },
          buttonModes: { items: ['clicked', 'held'], acceptReporters: true },
          textTypes: { items: ['header', 'footer', 'text', 'description'], acceptReporters: true },
          inputKinds: { items: ['text', 'number'], acceptReporters: true }
        }
      };
    }

    /* --- 标签方法: 无操作，仅用作视觉分区标题 --- */
    label_window_mgmt() { /* 无操作 */ }
    label_element_create() { /* 无操作 */ }
    label_element_controls() { /* 无操作 */ }
    label_events_reports() { /* 无操作 */ }
    ...
    setCustomFont({ FONT, GID, WID }) {
      ...
      if (!info) return;
      // 仅应用于文本类元素(标题/页脚/文本/描述或包含文本节点的包装器)
      try {
