...
var shared = new MarkdownItCallable();
/**
* Convert a Markdown string to an HTML string.
*
* @param src - Markdown source.
* @param env - Shared environment passed through parsing and rendering.
* @param options - Parser options. When omitted, a shared default instance is reused.
*/
function markdownToHtml(src, env = {}, options) {
	return (options ? new MarkdownItCallable(options) : shared).render(src, env);
}
/**
* Convert a single inline fragment (no block structure) to HTML.
*/
function markdownInlineToHtml(src, env = {}, options) {
	return (options ? new MarkdownItCallable(options) : shared).renderInline(src, env);
}
//#endregion
export { MarkdownItCallable as MarkdownIt, markdownToHtml as default, markdownToHtml, markdownInlineToHtml };

//# sourceMappingURL=markdown-it.single.mjs.map
